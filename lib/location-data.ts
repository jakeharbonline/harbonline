...
export const locations: LocationData[] = [
  ...
  },
  {
    ...
    name: 'Arundel',
    county: 'West Sussex',
    description: 'Arundel is a historic market town dominated by the magnificent Arundel Castle, with a thriving community of independent businesses, hospitality venues, and professional services.',
    localInfo: 'We work with Arundel SMEs and independents around the town centre and Arundel Castle. From hospitality to professional services, we build lightweight, search-optimised sites and support you long-term. Serving Arundel town centre, surrounding villages, and the South Downs area.',
    areasServed: ['Arundel town centre', 'Arundel Castle area', 'South Stoke', 'Burpham', 'Warningcamp'],
    keywords: [
      'web designer Arundel',
      'web developer Arundel',
      'website design Arundel',
      'Arundel web development',
      'web design near Arundel Castle',
    ],
  },
  {
    slug: 'selsey',
    name: 'Selsey',
    county: 'West Sussex',
    description: 'Selsey is a vibrant coastal town and popular tourist destination, with a strong community of cafés, trades, and tourism-focused businesses serving both residents and seasonal visitors.',
    localInfo: 'We support Selsey cafés, trades and tourism-focused businesses with fast builds and practical SEO. Mobile-first, Core Web Vitals-friendly and easy to update. Serving Selsey town centre, East Beach, West Beach, and surrounding coastal areas.',
    areasServed: ['Selsey town centre', 'East Beach', 'West Beach', 'Selsey Bill', 'Church Norton'],
    keywords: [
      'web designer Selsey',
      'web developer Selsey',
      'website design Selsey',
      'Selsey web development',
      'coastal business website design',
    ],
  },
];
