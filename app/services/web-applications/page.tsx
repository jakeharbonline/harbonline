...
import { Database, Users, BarChart, Lock, Code, TrendingUp, ArrowRight, Calendar, Calculator, FileText, Package, Wrench, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      ...
      <main>
        ...
        <Section id="examples" background="primary" spacing="normal">
